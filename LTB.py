...
class FeedForward_2(nn.Module):
    ...
    def flops(self, resolutions):
        ...
        return flops
    #用的Drsformer的
class FeedForward_3(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias):
        super(FeedForward_3, self).__init__()
...
class LightTransformerBlock(nn.Module):
    def __init__(self, dim, num_heads=4, ffn_expansion_factor=2.5,hidden_ratio=2.0, act_layer=nn.GELU, bias=False, LayerNorm_type='WithBias'):## Other option 'BiasFree'
        ...
        #self.ffn = FeedForward_2(dim, hidden_ratio, act_layer=act_layer)
        self.ffn = FeedForward_3(dim, ffn_expansion_factor, bias)
...
if __name__ == '__main__':
    ...
    transformer_block = LightTransformerBlock(64)#输入C
