...
def parse_args():
    ...
    parser.add_argument("--ckpt_name", type=str, default='SEcontract')
    parser.add_argument("--print_interval", type=int, default=1000)
    parser.add_argument("--train_data_path", type=str, default="DeepRock2D_new_default.h5")
    parser.add_argument("--valid_data_path", type=str, default="dataset/valid_data_")
